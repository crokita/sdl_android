...
public class UnsubscribeButtonTest extends BaseRpcTests {
	...
	protected RPCMessage createMessage() {
		...
		button = ButtonName.valueForString(JsonUtils.readStringFromJsonObject(paramsJson, UnsubscribeButton.KEY_BUTTON_NAME));
    ...
    public void testJsonConstructor () {
		...
		try {
			...
			assertEquals("Button name doesn't match input name", parameters.getString(UnsubscribeButton.KEY_BUTTON_NAME), cmd.getButtonName().toString());
